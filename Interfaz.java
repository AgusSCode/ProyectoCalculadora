...
public class Interfaz {
    ...
    public static void main(String[] args) {
    	...
    	JFrame frame = new JFrame("Calculadora");
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\5TO 2DA\\LPOO\\07-08-2023 LOGO Calculadora\\346399.png"));
    	frame.setBounds(600, 250, 300, 350);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Extract the number from the textField
                num1 = Integer.parseInt(textField.getText());

                // Display the entered number with a caret symbol (^)
                resultadoLabel2.setText("^" + num1);
                resultadoLabel2.setForeground(blanco);
                
                // Calculate the power of resultadoAux raised to num1
                resultado1 = (float) Math.pow(resultado1, num1);

                // Display the calculated result in the "resultadoLabel"
                resultadoLabel.setText("Resultado: " + resultado1);
                resultadoLabel.setForeground(blanco);
            }
        });
        ...
        btnNewButton_1_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
                ...
                resultadoLabel2.setText("\u221A" + num1d);
                resultadoLabel2.setForeground(blanco);
                
                resultado1 =  Math.pow(resultado1, 1/num1d);
    	...
    	private static void funcion_sistemas() {
            ...
            btnNewButton.setBounds(75, 48, 122, 23);
            panel.add(btnNewButton);
            ...
            btnNewButton_1.setBounds(75, 82, 122, 23);
            panel.add(btnNewButton_1);
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    calcular6.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            resultadoDet.setBounds(posicion_x, posicion_y+30, 219, 25);
